# Project - Using a public API (Weather App) 🖥️


In this project, I was expected to build a website using the Express/Node.js platform, with the Axios HTTP client, that integrates a chosen public API , which I chose a weather API (openweathermap.org). The goal was simple, the website should interact with the chosen API, retrieve data, and present it in a user-friendly manner.
